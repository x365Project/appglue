...
@RegisterExpression('Text', 'String Is Not In List', <NotContainsIcon />, ExpressionExpectedType.BOOLEAN)
export class StringListNotInExpression extends BaseExpression {
    ...
    render() {
        return (
            <BracketedDiv>
                ...
                <ExpressionPiece> not in </ExpressionPiece>
                <ExpressionPiece>
