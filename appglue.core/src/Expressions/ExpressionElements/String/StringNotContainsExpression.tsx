...
@RegisterExpression('Text', 'String Not Contains', <NotContainsIcon />, ExpressionExpectedType.BOOLEAN)
export class StringNotContainsExpression extends BaseExpression {
