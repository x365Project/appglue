...
@RegisterExpression('Text', 'String End With', <StartWithIcon />, ExpressionExpectedType.BOOLEAN)
export class StringEndWithExpression extends BaseExpression {
    ...
    render() {
        return (
            <BracketedDiv>
                ...
                <ExpressionPiece> end with </ExpressionPiece>
                <ExpressionPiece>
