                        ...
                        <div>
                          ...
                          <div>
                            <div className="custom-control custom-radio custom-control-inline mr-4">
                              ...
                              >
                                <i className="fab fa-cc-mastercard mr-1 font-size-20 align-top"/>{" "}
                                Credit / Debit Card
                              </Label>
                            </div>
                            <div className="custom-control custom-radio custom-control-inline mr-4">
                              ...
                              >
                                <i className="fab fa-cc-paypal mr-1 font-size-20 align-top"/>{" "}
                                Paypal
                              </Label>
                            </div>
                            <div className="custom-control custom-radio custom-control-inline mr-4">
                              ...
                              >
                                <i className="far fa-money-bill-alt mr-1 font-size-20 align-top"/>{" "}
                                Cash on Delivery
                              </Label>
                            </div>
                          </div>
                ...
                <Row className="my-4">
                  ...
                  <Col sm="6">
                    <div className="text-sm-right">
                      ...
                      >
                        <i className="mdi mdi-truck-fast mr-1"/> Proceed to
                        Shipping{" "}
                      </Link>
                    </div>
                  </Col>
